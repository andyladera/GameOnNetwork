...
INSERT INTO `reservas` (`id`, `id_usuario`, `id_institucion`, `fecha`, `hora_inicio`, `hora_fin`, `estado`) VALUES
	(1, 2, 1, '2025-06-15', '18:00:00', '20:00:00', 'confirmada'),
	(2, 2, 2, '2025-06-20', '16:00:00', '18:00:00', 'confirmada'),
	(3, 2, 3, '2025-06-25', '19:00:00', '21:00:00', 'pendiente');
...
-- Volcando datos para la tabla gameon.torneos_partidos: ~0 rows (aproximadamente)
